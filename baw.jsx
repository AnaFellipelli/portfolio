  ...
  return (
    <div className="bawx">
      ...
      <section className="bw-sec concrete" id="bw-screens">
        <div className="bw-wrap">
          <span className="bw-chip">the screens · 01</span><span className="bw-count">6 captures</span>
        ...
        {/* the full-bleed bands nest inside bw-wrap on purpose: the negative margins below
            cancel exactly this wrapper's own gutter + rail padding to reach the true viewport
            edge, then re-add the rail clearance for the image alone (same trick as manyfest's
            .mnf-full inside .mnf-wrap). without this wrapper the math has nothing to cancel and
            the band drifts left of the viewport instead of clearing the rail. */}
        <div className="bw-wrap">
        <figure className="bw-full" style={{ background: "#eeefe9" }}>
          <img src="images-baw/BAW1.jpg" alt="BAW homepage, full desktop scroll composed in two panes: the street-photography hero carousel with the 'we make noise not fashion' slogan bands, then the calçados and novidades carousels down to the footer" loading="lazy" width="2600" height="1172" />
        </figure>

        <figure className="bw-full" style={{ background: "#b6a2dd" }}>
        ...
        <figure className="bw-full" style={{ background: "#d6d7d2" }}>
          <img src="images-baw/BAW4.jpg" alt="Two desktop pages overlapped: a homepage grid of street-style lookbook tiles with discount tags, and in front, a cropped t-shirt product page with color swatches, size row and a payment info panel" loading="lazy" width="2600" height="1950" />
        </figure>

        <figure className="bw-full" style={{ background: "#282828" }}>
          <img src="images-baw/BAW5.jpg" alt="Two mobile screens in phone frames: the cart drawer with the green comprar band, and the search overlay with autocomplete suggestions" loading="lazy" width="2000" height="1500" />
        </figure>

        <figure className="bw-full" style={{ background: "#a995da" }}>
          <img src="images-baw/BAW6.jpg" alt="Two mobile screens in phone frames: a product page with size row and colorway swatches, and the 'você pode gostar' recommendations feeding into the newsletter signup" loading="lazy" width="2000" height="1500" />
        </figure>
        </div>
      </section>
