/* GENERATED by build-jsx.js from releve.jsx — do not edit this file.
   Edit releve.jsx and re-run: node build-jsx.js */
/* ════════════════════════════════════════════════════════════
...
const {
  useEffect: useEffectRlv,
  useState: useStateRlv
} = React;
...
const RLV_PHASES = [{
  ...
  k: "test · 04",
  h: "Six pairs of eyes, one demi-plié",
...
const RLV_OWN = [{
  h: "Product design",
  p: "The full app (home, upload flow, analysis view, progress) plus the design language: stage black, aurora, the bilingual correction card."
}, {
  h: "Correction engine",
  p: "Per-exercise analysers with phase detection, visibility gating, N-of-M logic, hysteresis and EMA smoothing. Plié fully built with 9 triggers."
}, {
  h: "ballet_database.json",
  p: "The single source of truth: 16 exercises, 47 corrections, every threshold and every EN/PT cue, shared by engine, app and coursework."
}, {
  h: "Front-end build",
  p: "The React prototype embedded above: timeline scrubbing, skeleton diagrams per correction, score ring, session history."
}, {
  h: "Backend & infra",
  p: "Flask upload/analysis API, MediaPipe pipeline, Supabase (auth + Postgres) with Teacher/Student roles, video in R2/S3 object storage."
}, {
  h: "Research & testing",
  p: "Studio observation, six personas, the user-testing protocol. 83% task success, 4.4/5 usability, and six dancers who'd use it again."
}];
...
function RlvPhone() {
  ...
  useEffectRlv(() => {
    const fit = () => setPs(Math.min(1, (window.innerHeight - 130) / 820, /* room for the kicker + caption */
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "rl-phone-fit",
    style: {
      width: Math.round(393 * ps),
      height: Math.round(820 * ps)
    }
    ...
    src: "https://releve-gvuu.onrender.com/",
...
function RlvCase({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "rlvx"
  }, /*#__PURE__*/React.createElement("style", null, __RLV_STYLE), /*#__PURE__*/React.createElement("nav", {
    className: "rl-rail",
    "aria-label": "sections"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => RlvScrollTo("rl-top")
  }, "overview"), /*#__PURE__*/React.createElement("button", {
    onClick: () => RlvScrollTo("rl-screens")
  }, "screens"), /*#__PURE__*/React.createElement("button", {
    onClick: () => RlvScrollTo("rl-process")
  }, "process"), /*#__PURE__*/React.createElement("button", {
    onClick: () => RlvScrollTo("rl-decisions")
  ...
  }, "They say dancers are graceful.\xA0✦\xA0"))), /*#__PURE__*/React.createElement("div", {
    className: "rl-wrap"
  }, /*#__PURE__*/React.createElement("button", {
    className: "rl-back",
  ...
  }, "elisava capstone · (r)elevē · 2026"), /*#__PURE__*/React.createElement("h1", {
    className: "rl-h1"
  }, "Close the gap between ", /*#__PURE__*/React.createElement("em", null, "feeling"), " and ", /*#__PURE__*/React.createElement("em", null, "reality.")), /*#__PURE__*/React.createElement("p", {
    className: "rl-hero-sub"
  }, "Ballet lives in millimetres, but its feedback hasn't changed in a century: a teacher's eye, a mirror, a voice across the room, gone by tomorrow. (r)elevē reads 33 body landmarks from a video, measures them against the RAD syllabus, and returns corrections a teacher would endorse. Timestamped, replayable, in English and Portuguese."), /*#__PURE__*/React.createElement("button", {
    className: "rl-cta",
    onClick: () => RlvScrollTo("rl-proto"),
    "aria-label": "open the live prototype"
  }, "Open the live prototype ", /*#__PURE__*/React.createElement("span", {
    className: "arr"
  }, "↓")))), /*#__PURE__*/React.createElement("section", {
    className: "rl-sec app",
    id: "rl-screens"
  }, /*#__PURE__*/React.createElement("div", {
    className: "rl-wrap"
    ...
    className: "rl-count"
  }, "live build + artifacts"), /*#__PURE__*/React.createElement("h2", {
    className: "rl-h2"
  }, "The product, ", /*#__PURE__*/React.createElement("em", null, "on stage.")), /*#__PURE__*/React.createElement("p", {
    className: "rl-lede"
  }, "Everything below is the real thing: the shipped deck and the working prototype,", /*#__PURE__*/React.createElement("strong", null, " running live in demo mode"), ". Pick an exercise, upload any video, and walk the same analysis flow the dancers tested.")), /*#__PURE__*/React.createElement("div", {
    className: "rl-demo-duo"
    ...
    className: "rl-proto-kicker"
  }, "live prototype · demo mode, click through it"), /*#__PURE__*/React.createElement(RlvPhone, null), /*#__PURE__*/React.createElement("figcaption", {
    className: "rl-cap"
  }, "prototype · live build · upload → analysis → timestamped corrections")))), /*#__PURE__*/React.createElement("section", {
    className: "rl-sec stage",
    id: "rl-process"
  }, /*#__PURE__*/React.createElement("div", {
    className: "rl-wrap"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "rl-h2"
  }, "Twenty years at the barre, ", /*#__PURE__*/React.createElement("em", null, "one capstone.")), /*#__PURE__*/React.createElement("p", {
    className: "rl-lede"
  }, "I danced for two decades before I designed this. The process ran research → personas → build → test, but the domain knowledge, what a correction sounds like when it lands, was the real method."), /*#__PURE__*/React.createElement("div", {
    className: "rl-process"
  }, RLV_PHASES.map((f, i) => /*#__PURE__*/React.createElement("div", {
    className: "rl-phase",
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "k"
  }, f.k), /*#__PURE__*/React.createElement("h4", null, f.h), /*#__PURE__*/React.createElement("p", null, f.p)))))), /*#__PURE__*/React.createElement("section", {
    className: "rl-sec app",
    id: "rl-decisions"
  }, /*#__PURE__*/React.createElement("div", {
    className: "rl-wrap"
    ...
    className: "rl-h2"
  }, "Objective where it measures, ", /*#__PURE__*/React.createElement("em", null, "human"), " where it speaks."), /*#__PURE__*/React.createElement("div", {
    className: "rl-decisions"
  }, RLV_DECISIONS.map((d, i) => /*#__PURE__*/React.createElement("div", {
    className: "rl-decision",
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "rl-dec-num"
  }, String(i + 1).padStart(2, "0")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "rl-dec-title"
    ...
    className: "rl-own"
  }, RLV_OWN.map((f, i) => /*#__PURE__*/React.createElement("div", {
    className: "rl-own-item",
    key: i
  ...
  }, "A solo capstone: design, engine, data and front-end were mine. Calibration leaned on a RAD teacher (the 5–10° head rule is hers), ELISAVA advisors framed the research, and six dancers lent their demi-pliés to the testing sessions."), /*#__PURE__*/React.createElement("div", {
    className: "rl-hind"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    className: "rl-chip"
  }, "in hindsight · 05"), /*#__PURE__*/React.createElement("h2", {
    className: "rl-h2 rl-hind-title",
    style: {
      fontSize: "clamp(32px, 4.5vw, 64px)"
    }
  }, "Next time, ", /*#__PURE__*/React.createElement("em", null, "I'd start with the UX."))), /*#__PURE__*/React.createElement("p", {
    className: "rl-lede"
  }, "The self-aware part: on this project my energy went into the AI and into learning to build across the whole stack, from the MediaPipe pipeline to the Flask backend to the React front-end. That's where the hard problems were, and I'm proud of how the engine turned out. But it meant the UX rode in the back seat. If I picked (r)elevē back up, I'd spend that same intensity on the experience: a first-run that teaches a dancer how to film themselves, a calmer path from upload to result, and correction cards tested for whether a tired dancer actually reads them at the barre. The engineering earned the trust; the UX is where I'd earn the habit.")), /*#__PURE__*/React.createElement(NextProjectFooter, {
    currentId: "releve",
    onAsk: onAsk
  }))));
}
