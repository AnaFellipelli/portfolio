...
const WV_DROP_STILLS = new Set(["weave-autocomplete.png",
// the same suggestion menu the recording types into
"weave-datagrid.png",
// a sixth table (column resize, annotation crop)
"weave-datagrid-2.png",
// a seventh table (pagination, annotation crop)
"weave-panel-2.png",
...
const WV_MOTION = {
  datagrid: {
    ...
    {
      src: "images-autodesk/tablerow.webp",
      w: 1250,
      h: 134,
      span: 2,
      inset: true,
      ...
      src: "images-autodesk/tableexpanf.webp",
      w: 1091,
      h: 888,
      label: "master detail",
      cap: "a row opens into a panel, and the rows keep scrolling under it"
    }, {
      src: "images-autodesk/table-parent.webp",
      w: 1288,
      h: 765,
      label: "row grouping",
  ...
  autocomplete: {
    ...
    flip: true,
    clips: [{
      src: "images-autodesk/autocomplete.webp",
      w: 574,
      h: 414,
      label: "suggestions",
  ...
  skeleton: {
    layout: "side",
    clips: [{
      src: "images-autodesk/skeleton.webp",
      w: 800,
      h: 552,
...
function WvBleed({
  ...
  const sample = () => {
    ...
    try {
      ...
      const ink = (x, y) => {
        const i = (y * W + x) * 4;
        return Math.abs(px[i] - base[0]) + Math.abs(px[i + 1] - base[1]) + Math.abs(px[i + 2] - base[2]) > 24 || base[3] > 8 && px[i + 3] < base[3] - 24;
      };
      let x0 = -1,
        x1 = -1,
        y0 = -1,
      ...
      const lf = x0 / W,
        wf = (x1 + 1 - x0) / W; /* content left + width, 0..1 */
      const tf = y0 / H,
        hf = (y1 + 1 - y0) / H; /* content top + height, 0..1 */
      ...
      setBox({
        ar: x1 + 1 - x0 + " / " + ((y1 + 1 - y0) * img.naturalHeight * W / (img.naturalWidth * H)).toFixed(4),
        w: 100 / wf,
        /* image width, % of the box  */
        left: -100 * lf / wf,
        top: -100 * tf / hf
      });
    } catch (e) {
  ...
  return /*#__PURE__*/React.createElement("figure", {
    className: "wv2-full" + (className ? " " + className : ""),
    style: bg ? {
      background: bg
    } : undefined
  }, /*#__PURE__*/React.createElement("div", {
    className: "wv2-bleed" + (box ? " cropped" : ""),
    style: box ? {
      aspectRatio: box.ar
    } : undefined
...
function WvDeep({
  ...
  const proseBlock = /*#__PURE__*/React.createElement("div", {
  ...
  const shotsBlock = shots.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "wv2-figs"
  ...
  const clipsBlock = motion && /*#__PURE__*/React.createElement("div", {
    className: "wv2-clips" + (motion.clips.length === 1 ? " one" : "")
  }, motion.clips.map((c, i) => /*#__PURE__*/React.createElement("figure", {
    className: "wv2-clip" + (c.span === 2 ? " span2" : "") + (c.inset ? " inset" : ""),
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "wv2-clip-head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "nm"
  }, p.name.replace(/\.$/, ""), " / ", c.label), /*#__PURE__*/React.createElement("span", {
    className: "rec"
  }, "prototype")), /*#__PURE__*/React.createElement("img", {
    src: c.src,
    alt: p.name.replace(/\.$/, "") + ": " + c.cap,
    width: c.w,
    height: c.h,
    loading: "lazy",
    decoding: "async"
  ...
  React.createElement("div", {
    className: "wv2-deep-body lead"
  }, clipsBlock, shots.length > 0 ? /*#__PURE__*/React.createElement("div", {
    className: "wv2-deep-cols"
  }, proseBlock, shotsBlock) : /*#__PURE__*/React.createElement("div", {
    className: "wv2-deep-prose trio"
  }, prose.map(([label, body]) => /*#__PURE__*/React.createElement("div", {
    className: "row",
    key: label
  }, /*#__PURE__*/React.createElement("span", {
    className: "k"
  }, label), /*#__PURE__*/React.createElement("p", null, body))))) : motion ?
  /*#__PURE__*/
  ...
  React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "wv2-deep-body" + (motion.flip ? " flip" : "")
  }, proseBlock, /*#__PURE__*/React.createElement("div", {
    className: "wv2-deep-side"
  }, clipsBlock)), shots.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "wv2-figs row"
  }, shots.map((s, i) => /*#__PURE__*/React.createElement("figure", {
    className: "wv2-fig",
    key: i,
    style: {
...
function WeaveCase({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "wv2-dec-p"
  }, d.body))))), /*#__PURE__*/React.createElement(WvBleed, {
    className: "bottom",
    src: "images-autodesk/autodesk1.jpg",
    ...
    className: "wv2-h2"
  }, "Nine combinations."), /*#__PURE__*/React.createElement("p", {
    ...
    onToggle: toggleDeep,
    onReveal: revealDeep
  })), /*#__PURE__*/React.createElement(WvBleed, {
    className: "bottom",
    src: "images-autodesk/autodesk2.jpg",
