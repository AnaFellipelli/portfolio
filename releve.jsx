    ...
    <div className="rlvx">
      ...
      <section className="rl-sec app" id="rl-decisions">
        <div className="rl-wrap">
          ...
          <div className="rl-hind">
            <div>
              <span className="rl-chip">in hindsight · 05</span>
              <h2 className="rl-h2 rl-hind-title" style={{ fontSize: "clamp(32px, 4.5vw, 64px)" }}>
                Next time, <em>I'd start with the UX.</em>
              </h2>
            </div>
            <p className="rl-lede">
              The self-aware part: on this project my energy went into the AI and into learning
              to build across the whole stack, from the MediaPipe pipeline to the Flask backend
              to the React front-end. That's where the hard problems were, and I'm proud of how
              the engine turned out. But it meant the UX rode in the back seat. If I picked
              (r)elevē back up, I'd spend that same intensity on the experience: a first-run that
              teaches a dancer how to film themselves, a calmer path from upload to result, and
              correction cards tested for whether a tired dancer actually reads them at the barre.
              The engineering earned the trust; the UX is where I'd earn the habit.
            </p>
          </div>
