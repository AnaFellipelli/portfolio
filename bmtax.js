...
function BmtaxCase({
  ...
  useEffectBmt(() => {
    ...
    const onScroll = () => {
      ...
      document.body.classList.toggle("bmt-hero-top", !!hero && hero.getBoundingClientRect().bottom > y);
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    src: "images-bmtax/BMTAx1.jpg",
    alt: "Contact flow, desktop and mobile: the 'entre em contato' form, then the 'obrigado pela mensagem' success state",
    loading: "lazy",
    width: "2600",
    height: "1172"
  })), /*#__PURE__*/React.createElement("figure", {
    ...
    src: "images-bmtax/BMTAx2.jpg",
    alt: "Two desktop pages: the blog listing 'inteligência tributária para decisões estratégicas', and the nosso time page with a founder's profile card",
    loading: "lazy",
    width: "2600",
    height: "1172"
  })), /*#__PURE__*/React.createElement("figure", {
    ...
    src: "images-bmtax/BMTAX5.jpg",
    alt: "Three mobile screens: the homepage hero, the 'a bmtax' intro copy, and the nossos números stat list",
    loading: "lazy",
    width: "2700",
    height: "1161"
  })), /*#__PURE__*/React.createElement("figure", {
    ...
    src: "images-bmtax/BMTAX4.jpg",
    alt: "BM TAX homepage, two panes: the film hero reading 'simplificando o universo tributário' with the products list below, then the nossos números stat band and the em alta blog carousel",
    loading: "lazy",
    width: "2700",
    height: "1212"
  })), /*#__PURE__*/React.createElement("figure", {
    ...
    className: "k"
  }, "motion · 04"), /*#__PURE__*/React.createElement("h4", null, "Specified, then shipped"), /*#__PURE__*/React.createElement("p", null, "The full-bleed film opens the site; after that, everything that moves resolves to an exact final state (counters, reveals, arrows), specified per element and delivered in 2024."))))), /*#__PURE__*/React.createElement("section", {
