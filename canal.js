/* GENERATED by build-jsx.js from canal.jsx — do not edit this file.
   Edit canal.jsx and re-run: node build-jsx.js */
/* ════════════════════════════════════════════════════════════
...
const {
  useEffect: useEffectCnl,
  useState: useStateCnl
} = React;
...
const CNL_OWN = [{
  h: "Homepage concept",
  p: "The full-bleed campaign hero with compressed white UI panels: the template that set the store's visual grammar."
}, {
  h: "Navigation workflow",
  p: "Desktop mega menu and the mobile accordion tree, mapped, tested against the catalog, and validated with the client before hi-fi."
}, {
  h: "PDP, mobile + desktop",
  p: "Photography-first product pages: panel hierarchy, size row states, the SHOP NOW band, the guia de tamanhos."
}, {
  h: "Compre junto module",
  p: "The editorial cross-sell: stacked pairing on mobile, three-look shelf with the LEVE JUNTO panel on desktop."
}, {
  h: "Responsive system",
  p: "One tracked, hairlined layout language across breakpoints, same affordances at every size."
}, {
  h: "Discovery artifacts",
  p: "The business model canvas workshop outputs that framed the whole engagement: personas, motivations, differentiators."
}];
...
function CnlModel() {
  ...
  if (missing) {
    return /*#__PURE__*/React.createElement("div", {
      className: "cn-model-ph",
      role: "img",
      "aria-label": "Canal campaign portrait"
...
function CanalCase({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "cnlx"
  }, /*#__PURE__*/React.createElement("style", null, __CNL_STYLE), /*#__PURE__*/React.createElement("nav", {
    className: "cn-rail",
    "aria-label": "sections"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => CnlScrollTo("cn-top")
  }, "overview"), /*#__PURE__*/React.createElement("button", {
    onClick: () => CnlScrollTo("cn-screens")
  }, "screens"), /*#__PURE__*/React.createElement("button", {
    onClick: () => CnlScrollTo("cn-process")
  }, "process"), /*#__PURE__*/React.createElement("button", {
    onClick: () => CnlScrollTo("cn-decisions")
  }, "decisions")), /*#__PURE__*/React.createElement("header", {
    className: "cn-hero",
    id: "cn-top"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cn-hero-model"
  }, /*#__PURE__*/React.createElement(CnlModel, null)), /*#__PURE__*/React.createElement("div", {
    className: "cn-wrap"
  }, /*#__PURE__*/React.createElement("button", {
    className: "cn-back",
  ...
  }, "canal concept ", /*#__PURE__*/React.createElement("span", {
    className: "d"
  }, "●"), " studio brizza · 2023"), /*#__PURE__*/React.createElement("h1", {
    className: "cn-h1"
  }, "Elegance,", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    className: "u"
  }, "on the shelf.")), /*#__PURE__*/React.createElement("p", {
    className: "cn-hero-sub"
  }, "Canal is a Brazilian women's fashion brand known for elegant design and quality materials. The brand had evolved; its e-commerce, the highest-traffic touchpoint, hadn't, and every visit widened the credibility gap. The brief: make the store feel like the brand. Quietly, and in three sprints."), /*#__PURE__*/React.createElement("div", {
    className: "cn-hero-actions"
  }, /*#__PURE__*/React.createElement("a", {
    className: "cn-cta",
    href: p.liveUrl || "https://www.canal.com.br/",
    target: "_blank",
    rel: "noopener noreferrer",
    "aria-label": "open the live canal store"
  }, "visit the website ", /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true"
  }, "↗"))))), /*#__PURE__*/React.createElement("section", {
    className: "cn-sec mist",
    id: "cn-screens"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cn-wrap"
    ...
    className: "cn-h2"
  }, "Let the clothes do the talking."), /*#__PURE__*/React.createElement("p", {
    className: "cn-lede"
  }, "Every image below is the designed storefront: mobile and desktop, framed as captured. The chrome stays black, white, and mist so the photography carries all the color; the interface's job is to get out of the clothes' way and then sell them.")), /*#__PURE__*/React.createElement("div", {
    className: "cn-wide"
    ...
    className: "cn-shot bare"
  }, /*#__PURE__*/React.createElement("img", {
    src: "Frame 1000005235.png",
    alt: "Canal storefront composed across two desktop browsers and a phone: full-bleed campaign photography with white tracked-type panels and the mega menu open",
    loading: "lazy"
  })), /*#__PURE__*/React.createElement("figcaption", {
    className: "cn-cap"
  }, "the storefront · mobile + desktop · one language at every size")), /*#__PURE__*/React.createElement("figure", {
    className: "cn-fig",
    style: {
      margin: 0
    }
    ...
    src: "canal-5.png",
    alt: "Desktop mega menu opened over the campaign hero: four hairlined columns of categories from camisas to coletes, thin tracked uppercase type",
    loading: "lazy"
  })), /*#__PURE__*/React.createElement("figcaption", {
    className: "cn-cap"
  }, "new in · desktop · the mega menu, four hairlined columns over the campaign")), /*#__PURE__*/React.createElement("div", {
    className: "cn-duo"
  }, /*#__PURE__*/React.createElement("figure", {
    className: "cn-fig",
    style: {
    ...
    src: "canal-1.png",
    alt: "Mobile product page in a phone frame: full-bleed campaign photo of an olive dress, white panel with price, size row and the black SHOP NOW band",
    loading: "lazy"
  })), /*#__PURE__*/React.createElement("figcaption", {
    className: "cn-cap"
  }, "pdp · mobile · photography full-bleed", /*#__PURE__*/React.createElement("br", null), "the ui compressed to the thumb")), /*#__PURE__*/React.createElement("figure", {
    className: "cn-fig",
    style: {
      margin: 0
    }
    ...
    src: "canal-2.png",
    alt: "Mobile navigation menu in a phone frame: accordion category tree with new in, roupas, essential expanded, jeans and outlet, hairline dividers",
    loading: "lazy"
  })), /*#__PURE__*/React.createElement("figcaption", {
    className: "cn-cap"
  }, "menu · mobile · the validated category tree, opened"))), /*#__PURE__*/React.createElement("figure", {
    className: "cn-fig",
    style: {
      margin: 0
    }
    ...
    src: "canal-6.png",
    alt: "Desktop product page compre junto section: three product portraits joined by squared plus signs, LEVE JUNTO panel with one price and a black SHOP NOW band",
    loading: "lazy"
  })), /*#__PURE__*/React.createElement("figcaption", {
    className: "cn-cap"
  }, "pdp · desktop · compre junto, the look assembled on one shelf")), /*#__PURE__*/React.createElement("div", {
    className: "cn-solo"
  }, /*#__PURE__*/React.createElement("figure", {
    className: "cn-fig",
    style: {
    ...
    src: "canal-3.png",
    alt: "Mobile compre junto: two stacked product portraits with quiet graphite 50% off tags, joined by a squared plus, prices and size rows beside each",
    loading: "lazy"
  })), /*#__PURE__*/React.createElement("figcaption", {
    className: "cn-cap"
  }, "pdp · mobile · compre junto stacked for one hand"))))), /*#__PURE__*/React.createElement("section", {
    className: "cn-sec paper",
    id: "cn-process"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cn-wrap"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "cn-h2"
  }, "Workshop to production, three sprints."), /*#__PURE__*/React.createElement("p", {
    className: "cn-lede"
  }, "Studio Brizza opened with the business before the screens: a canvas workshop set who Canal's customer is and why she buys, the navigation was locked next, and the UI was validated with the client before anything went to production."), /*#__PURE__*/React.createElement("div", {
    className: "cn-process"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cn-phase"
  }, /*#__PURE__*/React.createElement("div", {
    className: "k"
  }, "discover · 01"), /*#__PURE__*/React.createElement("h4", null, "Canvas workshop"), /*#__PURE__*/React.createElement("p", null, "A business model canvas workshop with the Canal team surfaced motivations, differentiators, and personas. The argument for restraint came straight from the customer.")), /*#__PURE__*/React.createElement("div", {
    className: "cn-phase"
  }, /*#__PURE__*/React.createElement("div", {
    className: "k"
  }, "define · 02"), /*#__PURE__*/React.createElement("h4", null, "Navigation first"), /*#__PURE__*/React.createElement("p", null, "The full navigation workflow, from the mega menu to the mobile accordion tree and fabric-level taxonomy, mapped and validated with the client before high-fidelity design began.")), /*#__PURE__*/React.createElement("div", {
    className: "cn-phase"
  }, /*#__PURE__*/React.createElement("div", {
    className: "k"
  }, "develop · 03"), /*#__PURE__*/React.createElement("h4", null, "Homepage concept"), /*#__PURE__*/React.createElement("p", null, "The concept set the grammar: full-bleed campaign photography, white panels, thin tracked uppercase, hairlines. Then the system extended to PLP, PDP, and compre junto.")), /*#__PURE__*/React.createElement("div", {
    className: "cn-phase"
  }, /*#__PURE__*/React.createElement("div", {
    className: "k"
  }, "deliver · 04"), /*#__PURE__*/React.createElement("h4", null, "Validated, shipped"), /*#__PURE__*/React.createElement("p", null, "Client-validated UI across mobile and desktop went to production inside three sprints. Live at canal.com.br, where the brand finally meets its own store."))))), /*#__PURE__*/React.createElement("section", {
    className: "cn-sec dark",
    id: "cn-decisions"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cn-wrap"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "cn-h2"
  }, "Elegance is what you leave out."), /*#__PURE__*/React.createElement("div", {
    className: "cn-decisions"
  }, CNL_DECISIONS.map((d, i) => /*#__PURE__*/React.createElement("div", {
    className: "cn-decision",
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "cn-dec-num"
  }, String(i + 1).padStart(2, "0")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "cn-dec-title"
    ...
    className: "cn-own"
  }, CNL_OWN.map((f, i) => /*#__PURE__*/React.createElement("div", {
    className: "cn-own-item",
    key: i
  ...
  }, "Built at Studio Brizza with the lead designer, who owned art direction and the client relationship. I designed alongside: homepage concept, navigation, PDP, compre junto, and the responsive system were mine, from the canvas workshop through production handoff."), /*#__PURE__*/React.createElement(NextProjectFooter, {
    currentId: "canal",
    onAsk: onAsk
  }))));
}
